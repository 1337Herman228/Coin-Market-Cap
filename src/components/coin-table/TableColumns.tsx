    ...
    const columns: TableColumnsType<DataType> = [
        {
            ...
            render: (text, record) => <FavouriteBtn />,
        },
        {
            title: "#",
            dataIndex: "rank",
        ...
        },
        {
            ...
            render: (text, record) => (
                <span data-testId="coin-name">{record.name}</span>
            ),
        },
        {
            title: "Price",
            ...
            render: (text, record) => (
                <span>{"$" + formatNumber(record.priceUsd, 2)}</span>
            ),
        },
        {
            title: "Market Cap",
            ...
            render: (text, record) => (
                <span>{"$" + formatLargeNumber(record.marketCapUsd)}</span>
            ),
        },
        {
            title: "24h %",
