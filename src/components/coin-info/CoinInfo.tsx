            ...
            <div className="coin-info-block">
                <div className="coin-price">
                    ...
                    <span className="coin-price__change">
                        <PercentModify
                            value={formatNumber(changePercent24Hr, 2)}
                        />
                    </span>
                </div>
                <div className="coin-info">
                    <div className="coin-info__row">
                        ...
                        <span className="coin-info__row-value">
                            ${formatLargeNumber(String(marketCapUsd))}
                        </span>
                    </div>
                    {supply && (
                        <div className="coin-info__row">
                            <span className="coin-info__row-key">
                                Total supply
                            </span>
                            <span className="coin-info__row-value">
                                ${formatLargeNumber(String(supply))} {symbol}
                            </span>
                        </div>
                    )}
                    {maxSupply && (
                        <div className="coin-info__row">
                            ...
                            <span className="coin-info__row-value">
                                ${formatLargeNumber(String(maxSupply))} {symbol}
                            </span>
                        </div>
                    )}
                </div>
