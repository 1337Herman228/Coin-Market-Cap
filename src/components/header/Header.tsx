...
import {
    setAllCoins,
    setFavouriteCoins,
} from "@/lib/redux/store/slices/coincapSlice";
...
const Header = () => {
    ...
    if (isLoading || !data || !allCoins)
        return (
            <div style={{ width: "100%" }}>
                <Skeleton.Button
                    style={{ width: "100vw", height: "56px" }}
                    active
                    size="small"
                />
            </div>
    ...
    const profitView = () => {
        if (profit >= 0)
            return (
                <span className="portfolio__income-profit">
            ...
            return (
                <span className="portfolio__income-decline">
                    {formatNumber(profit, 2)} ({formatNumber(profitPercent, 2)}
                    %)
                </span>
            );
            ...
            <div className="popular-coins">
                {data?.data.map((coin, index) => (
                    <div className="popular-coins__item">
                        <span className="popular-coins__item-name">
                            (#{coin.rank}) {coin.name}:{" "}
                        </span>
                        <span className="popular-coins__item-price">
                            ${formatNumber(coin.priceUsd, 1)}
                        </span>
                        <span className="popular-coins__item-percent">
                            <PercentModify
                                value={formatNumber(coin.changePercent24Hr, 2)}
                            />
                        </span>
                    </div>
                ))}
                ...
                >
                    <div className="portfolio__btn">
                        ...
                        >
                            ...
                            />
                            <path
                                d="M6.87995 13.18C6.53995 13.18 6.23995 12.95 6.14995 12.61C6.04995 12.21 6.28995 11.8 6.69995 11.7C10.38 10.78 13.62 8.77 16.09 5.9L16.55 5.36C16.82 5.05 17.29 5.01 17.61 5.28C17.92 5.55 17.96 6.02 17.69 6.34L17.23 6.88C14.56 10 11.04 12.17 7.05995 13.16C6.99995 13.18 6.93995 13.18 6.87995 13.18Z"
                                fill="#292D32"
                            />
                            <path
                                d="M17.1199 9.52C16.7099 9.52 16.3699 9.18 16.3699 8.77V6.6H14.1899C13.7799 6.6 13.4399 6.26 13.4399 5.85C13.4399 5.44 13.7799 5.1 14.1899 5.1H17.1199C17.5299 5.1 17.8699 5.44 17.8699 5.85V8.78C17.8699 9.19 17.5399 9.52 17.1199 9.52Z"
                                fill="#292D32"
                            />
                            <path
